...
namespace ARSWebMVC.Controllers
{
    public class TestController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Queue<List<Route>> queueListRoute = FindAllPossibleRoute(1, 6);
        ...
        private void RecursiveFindPossibleRoutev1(int cityAID, int cityBID, ref List<Route> lstRoute, ref List<List<Route>> lstListRoute)
        {
            ...
            List<Route> lstTryRoute = dbRoutes.Where(r => r.CityAID == cityAID).ToList();
            ...
            foreach (Route tryRoute in lstTryRoute)
            {
                ...
                RecursiveFindPossibleRoute(tryRoute.CityBID, cityBID, ref lstCopyRoute, ref lstListRoute);
        ...
        private void RecursiveFindPossibleRoute3(int cityAID, int cityBID, ref List<Route> lstRoute, ref List<List<Route>> lstListRoute)
        {
